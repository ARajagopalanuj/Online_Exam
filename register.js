...
document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener("submit", async (event) => {
        ...
        try {
            const response = await fetch("https://73f15072dce9.ngrok-free.app/exam/user/register", {
                method: "POST",
...
if(loginForm){
    loginForm.addEventListener("submit",async (event)=>{
        ...
        try{
            ...
            const response= await fetch("https://73f15072dce9.ngrok-free.app/exam/user/login",{
                method:"POST",
                headers:{"Content-Type":"application/json"},
 ...
 const topics=localStorage.getItem("topic")?JSON.parse(localStorage.getItem("topic")):[];
    ...
    const apiUrl = `https://73f15072dce9.ngrok-free.app/exam/user/${element.topic}`;
...
submitBtn.addEventListener("click",async()=>{
    ...
    try{
        const responseAnswer=await fetch("https://73f15072dce9.ngrok-free.app/exam/user/writeExam",{
            method:"POST",
            headers:{"Content-Type":"application/json"},
